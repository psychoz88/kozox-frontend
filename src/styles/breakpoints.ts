...
export const lgBp = 992; // desktop
export const xLgBp = 1200;
export const xxLgBp = 1400;
...
export const lg = `${lgBp}px`;
export const xlg = `${xLgBp}px`;
export const xxlg = `${xxLgBp}px`;
